...
echo '<a href="attendancelist.php?mark='.$_GET['aid'].'&class='.$_GET['class'].'&aid='.$_GET['aid'].'&date='.$_GET['date'].'&subject='.$_GET['subject'].'&stime='.$_GET['stime'].'" class="btn btn-primary">Mark Attendance</a>';
}
?>
<?php
             if (isset($_GET['view'])) {
               echo '<a href="download_attendance_report.php?aid=' . $_GET['aid'] . '" class="btn btn-info">Download Attendance Report</a>';
             }
             ?>
</div>
</form>
...
<?php
                 ...
                 if ($result->num_rows > 0) {
                   ...
                   while ($row = $result->fetch_assoc()) {
                     echo "<tr><td> " . $row["sid"]. " </td><td> " . $row["fname"]." " . $row["lname"]." </td><td><div class='form-group'><input type='hidden' name='sid[]'' value='".$row["sid"]."' /><input type='hidden' name='aid[]'' value='".$_GET["aid"]."' /><div class='radio '><label style='width: 100px'><input type='radio' name='att[".$x."]' value='Present' checked> &nbsp&nbsp&nbspPresent</label><label style='width: 100px'><input type='radio' name='att[".$x."]' value='Absent' checked> &nbsp&nbsp&nbspAbsent</label></div></div></td></tr>";
                     $x++;
                   }
                 }
                 ?>
...
<?php
               ...
               if ($result->num_rows > 0) {
                 while ($row = $result->fetch_assoc()) {
                   echo "<tr><td> " . $row["sid"]. " </td><td> " . $row["fname"]." " . $row["lname"]." </td><td>" . $row["status"]. " </td></tr>";
                 }
               }
               ?>
</tbody>
